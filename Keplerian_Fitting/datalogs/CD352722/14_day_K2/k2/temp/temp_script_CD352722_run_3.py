...
def my_prior(theta):
    ...
    lp += Uniform(theta[5], [10, 20], -2.3025850929940455)
...
ndim = 12
betas = [1.0, 0.6099, 0.3651, 0.224, 0.1338, 0.07218, 0.03796, 0.02057, 0.009301, 0.002111]
progress = True
...
def run_thing():
    ...
    saver = PTHDFBackend('CD352722_run_3.h5')
