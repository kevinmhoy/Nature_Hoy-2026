...
my_data = pd.read_csv('datalogs/CD352722/run_1/k2/temp/temp_data.csv', index_col=0)
...
def my_prior(theta):
    ...
    lp += Uniform(theta[5], [80, 100], -2.995732273553991)
...
ndim = 12
betas = [1.0, 0.5761, 0.3286, 0.1873, 0.108, 0.06172, 0.03489, 0.01882, 0.008387, 0.002111]
progress = True
...
def run_thing():
    ...
    saver = PTHDFBackend('CD352722_run_1.h5')
