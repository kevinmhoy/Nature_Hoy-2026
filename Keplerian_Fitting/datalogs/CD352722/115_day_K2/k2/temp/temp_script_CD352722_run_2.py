...
my_data = pd.read_csv('datalogs/CD352722/run_2/k2/temp/temp_data.csv', index_col=0)
...
def my_prior(theta):
    ...
    lp += Uniform(theta[5], [100, 120], -2.995732273553991)
...
ndim = 12
betas = [1.0, 0.6344, 0.4004, 0.2422, 0.1426, 0.07853, 0.04108, 0.02024, 0.008396, 0.002111]
progress = True
...
def run_thing():
    ...
    saver = PTHDFBackend('CD352722_run_2.h5')
