...
my_data = pd.read_csv('datalogs/CD352722/run_4/k2/temp/temp_data.csv', index_col=0)
...
def my_prior(theta):
    ...
    lp += Uniform(theta[5], [65, 75], -2.3025850929940455)
...
ndim = 12
betas = [1.0, 0.6125, 0.3595, 0.2044, 0.1139, 0.06161, 0.03455, 0.01932, 0.008702, 0.002111]
progress = True
...
def run_thing():
    ...
    saver = PTHDFBackend('CD352722_run_4.h5')
